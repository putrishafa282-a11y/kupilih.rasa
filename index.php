...
<body>
    ...
    <div id="konten-landing">
        ...
        <div id="menu-utama">
            ...
            <section class="menu-container">
                ...
                <div class="grid-menu">
                    <div class="card">
                        ...
                        <span class="harga">Rp 3.000</span>
                        <button class="btn-pesan" onclick="tambahKeKeranjang('CISTIK Ayam Suwir', 3000)">Pesan Sekarang</button>
                    </div>
                </div>
            </section>
            ...
            <section class="menu-container">
                <h2>POTATO CURLY</h2>
                <P>Kentang goreng potong spiral yang super krispi di luar dan lembut di dalam. Dibumbui dengan perpaduan Jagung Manis & Balado, lalu disiram Saos Pedas plus Mayonais yang creamy. Sensasi rasa manis, pedas, gurih, dan creamy yang bikin nagih dalam sekali gigit!</P>
                <div class="card">
                    <img src="images/potato-curly.png" alt="potato-curly">
                    <h4>Bumbu Tabur Balado</h4>
                    <span class="harga">Rp 5.000</span>
                    <button class="btn-pesan" onclick="tambahKeKeranjang('Bumbu Tabur Balado', 5000)">Pesan Sekarang</button>
                    <h4>Bumbu Tabur Jagung Manis</h4>
                    <span class="harga">Rp 5.000</span>
                    <button class="btn-pesan" onclick="tambahKeKeranjang('Bumbu Tabur Jagung Manis', 5000)">Pesan Sekarang</button>
                    <h4>Saos Pedas</h4>
                    <span class="harga">Rp 5.000</span>
                    <button class="btn-pesan" onclick="tambahKeKeranjang('Saos Pedas', 5000)">Pesan Sekarang</button>
                    <h4>Mayonais</h4>
                    <span class="harga">Rp 5.000</span>
                    <button class="btn-pesan" onclick="tambahKeKeranjang('Mayonais', 5000)">Pesan Sekarang</button>
                </div>
            </section>
